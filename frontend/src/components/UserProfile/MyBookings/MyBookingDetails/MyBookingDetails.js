    ...
    <>
        ...
        <div className="myBookings-details-container">
            ...
            <div className="myBooking-psychologist-detail-wrap">
                <p>{props.location.myBooking.psychologist_first_name} {props.location.myBooking.psychologist_last_name}</p>
                <p>{props.location.myBooking.date}</p>
                <p>{props.location.myBooking.time_in_str}</p>
            </div>

            <div className="video-chat-container">
                <img className="video-logo" src={videoLogo} alt="video-logo" />
